!function (e, t) {
	...
	function n(e, t) {
		for (var n, r = [], o = 0; o < e.length; ++o) {
			if (n = a[e[o]] || i(e[o]), !n)
				throw "module definition dependecy not found: " + e[o];
			r.push(n)
		}
		t.apply(null, r)
	}
	...
	r("tinymce/codesampleplugin/Prism", [], function () {
		...
		n = function () {
			...
			n = t.Prism = {
				util : {
					...
					clone : function (e) {
						...
						case "Object":
							var r = {};
							for (var i in e)
								e.hasOwnProperty(i) && (r[i] = n.util.clone(e[i]));
							return r;
						case "Array":
				...
				languages : {
					...
					DFS : function (e, t, r) {
						for (var i in e)
							e.hasOwnProperty(i) && (t.call(e, i, e[i], r || i), "Object" === n.util.type(e[i]) ? n.languages.DFS(e[i], t) : "Array" === n.util.type(e[i]) && n.languages.DFS(e[i], t, i))
					}
				},
				plugins : {},
				highlightAll : function (e, t) {
					for (var r, i = document.querySelectorAll('code[class*="language-"], [class*="language-"] code, code[class*="lang-"], [class*="lang-"] code'), o = 0; r = i[o++]; )
						n.highlightElement(r, e === !0, t)
				},
				highlightElement : function (r, i, o) {
					for (var a, s, l = r; l && !e.test(l.className); )
						l = l.parentNode;
					l && (a = (l.className.match(e) || [, ""])[1], s = n.languages[a]),
					r.className = r.className.replace(e, "").replace(/\s+/g, " ") + " language-" + a,
					l = r.parentNode,
					...
					if (n.hooks.run("before-highlight", u), i && t.Worker) {
						...
						u.highlightedCode = n.highlight(u.code, u.grammar, u.language), n.hooks.run("before-insert", u), u.element.innerHTML = u.highlightedCode, o && o.call(r), n.hooks.run("after-highlight", u), n.hooks.run("complete", u)
				},
								...
								for (var h = 0; h < o.length; h++) {
									...
									if (!(g instanceof i)) {
										...
										if (v) {
											...
											N = [h, 1];
											x && N.push(x);
											var E = new i(s, d ? n.tokenize(v, d) : v, m);
											N.push(E),
											w && N.push(w),
											Array.prototype.splice.apply(o, N)
										}
									}
								}
							}
			...
			if (r.stringify = function (e, t, i) {
				...
				if ("Array" === n.util.type(e))
					...
					return "<" + o.tag + ' class="' + o.classes.join(" ") + '" ' + s + ">" + o.content + "</" + o.tag + ">"
						...
						o = r.code,
						a = r.immediateClose;
						t.postMessage(n.highlight(o, n.languages[i], i)),
						a && t.close()
					}, !1), t.Prism) : t.Prism
		}
		();
		...
		n.languages.markup && (n.hooks.add("before-highlight", function (e) {
				...
				if ("php" === e.language) {
					for (var t, r = 0; t = e.tokenStack[r]; r++)
						e.highlightedCode = e.highlightedCode.replace("{{{PHP" + (r + 1) + "}}}", n.highlight(t, e.grammar, "php").replace(/\$/g, "$$$$"));
	...
	r("tinymce/codesampleplugin/Dialog", ["tinymce/dom/DOMUtils", "tinymce/codesampleplugin/Utils", "tinymce/codesampleplugin/Prism"], function (e, t, n) {
		...
		function i(e, t, r) {
			e.undoManager.transact(function () {
				var i = o(e);
				r = l.encode(r),
				i ? (e.dom.setAttrib(i, "class", "prettyprint linenums language-" + t), i.innerHTML = r, n.highlightElement(i), e.selection.select(i)) : (e.insertContent('<pre id="__new" class="prettyprint lang-' + t +' linenums language-' + t + '">' + r + "</pre>"), e.selection.select(e.$("#__new").removeAttr("id")[0]))
			})
		}
		function o(e) {
	...
	r("tinymce/codesampleplugin/Plugin", ["tinymce/Env", "tinymce/PluginManager", "tinymce/codesampleplugin/Prism", "tinymce/codesampleplugin/Dialog", "tinymce/codesampleplugin/Utils"], function (e, t, n, r, i) {
		...
		t.add("codesample", function (t, s) {
			function l() {
				var e,
				n = t.settings.codesample_content_css;
			...
			e.ceFalse && (t.on("PreProcess", function (e) {
					u("pre[contenteditable=false]", e.node).filter(a(i.isCodeSample)).each(function (e, t) {
						var n = u(t),
						r = t.textContent;
						n.attr("class", u.trim(n.attr("class"))),
						n.removeAttr("contentEditable"),
						n.empty().append(u("<code></code>").each(function () {
								this.textContent = r
							}))
					})
					...
					e.length && t.undoManager.transact(function () {
						e.each(function (e, r) {
							...
							r.contentEditable = !1,
							r.innerHTML = t.dom.encode(r.textContent),
							n.highlightElement(r),
							r.className = u.trim(r.className)
						})
					})
				}), t.addCommand("codesample", function () {
					var e = t.selection.getNode();
					t.selection.isCollapsed() || i.isCodeSample(e) ? r.open(t) : t.formatter.toggle("code")
